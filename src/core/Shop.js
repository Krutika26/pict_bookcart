...
const Shop = () => {
    ...
    const getPHP = () => {
        ...
        formData.append("content2", "test22222asas");
        fetch("http://localhost:80/admin_panel/api.php", {
          method: "POST",
          headers: {
          ...
          .then((response) => {
            ...
            setFilteredResults(response["items"]);
          });
      }
            ...
            <div className="shop-parent">
                ...
                <div className="shop-box">
                    ...
                    <div className="flex-container wrap">
                        {filteredResults.map((product, i) => (<Card key={i} product={product}></Card>))}
                    </div>
                    {loadMoreButton()}
                </div>
